...
import { Store, BarChart2, ArrowLeft, LogOut, Tag, Package } from 'lucide-react'
    ...
    <div className="flex h-screen bg-slate-900 text-white overflow-hidden flex-col">
      <header className="h-11 bg-slate-950 border-b border-slate-800 flex items-center justify-between px-4 shrink-0">
        <div className="flex items-center gap-3">
          <Link to="/login" className="text-slate-400 hover:text-white transition-colors" title={lang === 'bn' ? 'লগআউট' : 'Logout'}>
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-semibold text-white">1to99 POS</span>
          </div>
